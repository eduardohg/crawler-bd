...
<table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-lg-4 h4">Pontuacao</th>
                            <th class="col-lg-4 h4">Aproveitamento</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach var="historico" items="${requestScope.historicoList}">
                            <tr id="tabela">
                                ...
                                <td>
                                	<span class="h4"><c:out value="${historico.pontuacao}"/></span>
                                </td>
                                <td>
                                	<span class="h4"><c:out value="${historico.aproveitamento}"/></span>
                                </td>                                                    
                            </tr>
                        </c:forEach>
                    </tbody>
    ...
    <script>
        ...
        function generateGraph(ctx, labels, data, colors){
            ...
            options: {
                title: {
                    display: true,
                    fontSize: 20,
                    text: 'RELATÓRIO DE APROVEITAMENTO DE CADA SELEÇÃO(%)'
                },
                labels: {
                    fontStyle: "bold"
                },
        ...
        <%String data = (String)request.getAttribute("data");out.print(data);%>,'red');
