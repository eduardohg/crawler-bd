...
<table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="col-lg-4 h4">Titulos</th>
                    ...
                    <tbody>
                        <c:forEach var="historico" items="${requestScope.historicoList}">
                            <tr id="tabela">
                                ...
                                <td>
                                	<span class="h4"><c:out value="${historico.titulos}"/></span>
                                </td>                                               
                            </tr>
                        </c:forEach>
                    </tbody>
    ...
    <script>
        ...
        <%String data = (String)request.getAttribute("data");out.print(data);%>,
        ['red','green','blue','yellow','black','brown','silver','gold']);
